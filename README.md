...
课题组文献速递制作工具，支持从期刊目录页一键提取文章、批量翻译、格式化输出。

## 在线使用

👉 [点击打开工具](https://mohaixin22.gitee.io/文献速递工作台/)
...
1. 在工具"录入文章"页面，将**目录提取器**和**文章提取器**两个书签拖到浏览器书签栏
...
- 各人数据存储在本地浏览器，互不干扰
- 翻译需配合 Claude 对话使用（工具会自动生成提示词）
- 书签在不同期刊网站的兼容性不同，如遇抓取失败可手动粘贴内容
```

---

粘贴时把第4行的链接换成你实际的 Gitee Pages 地址。如果还没开启 Pages，去仓库 **「管理」→「Gitee Pages」→ 选 master 分支 → 启动** 即可，大约1分钟后生效。
